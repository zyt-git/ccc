...
public class NoteUtil {
    ...
    public static String getCode(String moble){
        ...
        nvps.add(new BasicNameValuePair("mobile", moble));
        ...
        Map<String,String> map = JSONObject.parseObject(code, Map.class);
        //List<Map> maps = JSONArray.parseArray(code, Map.class);
        return map.get("obj");
    }
